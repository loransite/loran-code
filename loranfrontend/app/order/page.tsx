  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 to-pink-50 py-12 px-4 mt-20">
      <motion.div initial={{ opacity: 0, y: -30 }} animate={{ opacity: 1, y: 0 }} className="max-w-7xl mx-auto">
        ...
        <p className="text-center text-gray-600 mb-12">View your purchases and cart items</p>
                ...
                <motion.div key={order._id} whileHover={{ scale: 1.02 }} className="bg-white rounded-lg shadow-lg overflow-hidden border-l-4 border-orange-500">
                  <div className="p-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                      ...
                      <div className="flex items-end"><button onClick={() => router.push('/catalogue')} className="w-full px-4 py-2 bg-gradient-to-r from-pink-500 to-indigo-600 text-white rounded font-semibold hover:shadow-lg">Pay Now</button></div>
                    </div>
                  </div>
                </motion.div>
              ))}
